...
public class puzzlepie extends Application{
    ...
    private void init(Stage primaryStage){
        ...
        int numOfRows = (int) (image.getWidth() / (Piece.SIZE));
        //create desk
        ...
        Menu clue = new Menu("Задание, пояснения и подсказки");
        MenuItem help1 = new MenuItem("1 уровень");
        MenuItem help2 = new MenuItem("2 уровень");
        MenuItem help3 = new MenuItem("3 уровень");
        help1.setOnAction(e -> Box.display("Задание 1 уровне", "Закрыть окно"));
        help2.setOnAction(e -> Box2.display("Задание 2 уровня", "Закрыть окно"));
        help3.setOnAction(e -> Box3.display("Задание 3 уровня", "Закрыть окно"));
        clue.getItems().addAll(help1, help2, help3);
        menuBar.getMenus().add(clue);
        TextArea textArea = new TextArea();       //текстовое поле сверху
        textArea.setPromptText("Введи команду");
        textArea.setPrefRowCount(5);
        textArea.setMaxWidth(numOfColumns*Piece.SIZE);
        Button sendCode = new Button("Отправить");
        HBox buttonBox = new HBox(8);
        buttonBox.getChildren().addAll(shuffleButton, solveButton);
        //create vbox for desk and buttons
        VBox vb = new VBox(10);
        vb.getChildren().add(menuBar);
        vb.getChildren().addAll(textArea, sendCode);
        ...
        public Piece(Image image, final double correctX, final double correctY,
            ...
            setOnMouseDragged(new EventHandler<MouseEvent>() {
                public void handle(MouseEvent me) {
                    ...
                    double maxTranslateY = (deskWidth - Piece.SIZE + 70f) - correctY;
